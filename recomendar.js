...
//Funcion para visualizar la matriz de similitud
function mostrarMatrizSimilitud(matrizSimilitud) {
    console.log('MATRIZ DE SIMILITUD');
    for (let i = 0; i < matrizSimilitud.length; i++) {
        let fila = "[" + i + "] => ";
        for (let j = 0; j < matrizSimilitud[i].length; j++) {
            fila = fila + matrizSimilitud[i][j].toFixed(3);
            fila = fila + "\t\t";
        }
        console.log(fila);
    }
...
//Funcion para visualizar la matriz de resultados
function mostrarMatrizResultado(matrizResultado) {
    ...
    for (let i = 0; i < matrizResultado.length; i++) {
        ...
        for (let j = 0; j < matrizResultado[i].length; j++) {
            fila = fila + matrizResultado[i][j].toFixed(3);
            fila = fila + "\t\t";
        }
        console.log(fila);
    }
...
if (comprobar() != 2) {
    ...
    if (!fs.existsSync(fileName)) {
        ...
        console.log(`1. Metrica empleada: ${process.argv[3]} \n`);
        console.log(`2. Metodo de prediccion:  ${process.argv[5]} \n`);
        console.log(`3. Número de vecinos: ${process.argv[4]} \n`);
        mostrarMatrizSimilitud(matrizSimilitud);
